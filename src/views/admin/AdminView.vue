    ...
    <header class="text-gray-600 body-font bg-lightblue">
        <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center justify-between">
            ...
            <router-link to="/" class="flex gap-3">
                <west/> voltar para Home
            </router-link>
        </div>
    </header>
    <div class="w-full h-screen cursor-pointer  rounded-lg shadow container flex justify-center items-center mx-auto flex-col">
        <div class="flex items-center justify-center bg-blue rounded">
            <div class=" bg-gray-100 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0">
                ...
                <button class="btn" @click="loginAdmin">Button</button>
